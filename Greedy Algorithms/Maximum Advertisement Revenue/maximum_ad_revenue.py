...
def max_dot_product(first_sequence, second_sequence):
    ...
    seq1 = sorted(first_sequence, reverse=True)
    seq2 = sorted(second_sequence, reverse=True)
    mapped = zip(seq1, seq2)
    return sum(value1 * value2 for value1, value2 in mapped)
